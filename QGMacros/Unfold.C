...
//Getting the histograms
	...
	if(isMC)sprintf(selection,"eventWeight*( %f < ptJet0 && ptJet0<%f && %f<rhoPF && rhoPF<%f)",PtMin,PtMax,RhoMin,RhoMax);
	else sprintf(selection,"( %f < ptJet0 && ptJet0<%f && %f<rhoPF && rhoPF<%f)",PtMin,PtMax,RhoMin,RhoMax);
	t1->Draw(name,selection,"goff");h1->Scale(1./h1->Integral());

	sprintf(name,"%s>>var2",varName);
	if(isMC)sprintf(selection,"eventWeight*( %f < ptJet0 && ptJet0<%f && %f<rhoPF && rhoPF <%f&& passedID_FULL && !btagged) ",PtMin,PtMax,RhoMin,RhoMax);
	else sprintf(selection,"( %f < ptJet0 && ptJet0<%f && %f<rhoPF && rhoPF <%f&& passedID_FULL && !btagged) ",PtMin,PtMax,RhoMin,RhoMax);
...
//Print the output
	...
	sprintf(selection,"eventWeight*( %f < ptJet0 && ptJet0<%f && %f<rhoPF && rhoPF<%f && abs(pdgIdPartJet0) <5) ",PtMin,PtMax,RhoMin,RhoMax);
	...
	sprintf(selection,"eventWeight*( %f < ptJet0 && ptJet0<%f && %f<rhoPF&&rhoPF<%f && abs(pdgIdPartJet0) ==21) ",PtMin,PtMax,RhoMin,RhoMax);
